...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "com/mithraobjects/Course";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "com.mithraobjects.Course";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("com.mithraobjects.Course");
	...
	public static class CourseRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Course, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "com.mithraobjects.CourseFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> courseId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Department", "courses");
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("com.mithraobjects.Course");
		isFullCache = false;
		isOffHeap = false;
	}
