...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "com/mithraobjects/Faculty";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "com.mithraobjects.Faculty";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("com.mithraobjects.Faculty");
	...
	public static class FacultyRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Faculty, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "com.mithraobjects.FacultyFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> departmentId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Department", "faculty");
		...
		public IntegerAttribute<ParentOwnerType> personId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Person", "faculty");
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("com.mithraobjects.Faculty");
		isFullCache = false;
		isOffHeap = false;
	}
