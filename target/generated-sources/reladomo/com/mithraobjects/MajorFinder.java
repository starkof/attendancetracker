...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "com/mithraobjects/Major";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "com.mithraobjects.Major";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("com.mithraobjects.Major");
	...
	public static class MajorRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Major, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "com.mithraobjects.MajorFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> majorId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Department", "major");
				this.majorId = result;
			}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("com.mithraobjects.Major");
		isFullCache = false;
		isOffHeap = false;
	}
