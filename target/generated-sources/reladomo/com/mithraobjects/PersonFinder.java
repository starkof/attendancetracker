...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "com/mithraobjects/Person";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "com.mithraobjects.Person";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("com.mithraobjects.Person");
	...
	public static class PersonRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Person, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "com.mithraobjects.PersonFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> genderId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Gender", "people");
		...
		public IntegerAttribute<ParentOwnerType> maritalStatusId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "MaritalStatus", "people");
		...
		public IntegerAttribute<ParentOwnerType> nationalityId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("com.mithraobjects", "Nationality", "people");
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("com.mithraobjects.Person");
		isFullCache = false;
		isOffHeap = false;
	}
