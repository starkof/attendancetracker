...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "tracker/domain/Nationality";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "tracker.domain.Nationality";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("tracker.domain.Nationality");
	...
	public static class NationalityRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Nationality, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "tracker.domain.NationalityFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("tracker.domain.Nationality");
		isFullCache = false;
		isOffHeap = false;
	}
