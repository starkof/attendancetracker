...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "tracker/domain/LectureHall";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "tracker.domain.LectureHall";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("tracker.domain.LectureHall");
	...
	public static class LectureHallRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<LectureHall, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "tracker.domain.LectureHallFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("tracker.domain.LectureHall");
		isFullCache = false;
		isOffHeap = false;
	}
