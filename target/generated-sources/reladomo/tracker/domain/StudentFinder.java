...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "tracker/domain/Student";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "tracker.domain.Student";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("tracker.domain.Student");
	...
	public static class StudentRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Student, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "tracker.domain.StudentFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> majorId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("tracker.domain", "Major", "students");
				this.majorId = result;
			}
		...
		public IntegerAttribute<ParentOwnerType> personId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("tracker.domain", "Person", "student");
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("tracker.domain.Student");
		isFullCache = false;
		isOffHeap = false;
	}
