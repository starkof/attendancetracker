...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "tracker/domain/ClassTimeSlot";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "tracker.domain.ClassTimeSlot";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("tracker.domain.ClassTimeSlot");
	...
	public static class ClassTimeSlotRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<ClassTimeSlot, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "tracker.domain.ClassTimeSlotFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("tracker.domain.ClassTimeSlot");
		isFullCache = false;
		isOffHeap = false;
	}
